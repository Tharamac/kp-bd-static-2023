        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-[#FDA172] w-auto md:w-[640px] rounded-2xl px-4 mx-4 sm:mx-16 md:mx-auto pt-4 pb-8 items-center h-full justify-center">
            ...
            <div className="mt-6 flex items-center justify-between gap-x-6">
                ...
                <div className="flex items-center gap-x-6">
                    ...
                    <button type="submit" className="rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">ส่งคำอวยพร</button>
                </div>
